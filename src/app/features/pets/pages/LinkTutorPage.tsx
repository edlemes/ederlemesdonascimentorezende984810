            ...
            ${
              isLinking
                ...
                : disabled
                  ...
                  : "bg-linear-to-r from-blue-500 to-indigo-600 text-white hover:from-indigo-600 hover:to-indigo-700 hover:shadow-lg hover:shadow-indigo-200/50 cursor-pointer active:scale-[0.98]"
            }
          `}
        >
          <span
...
export function LinkTutorPage() {
  const { id: petId, isValid } = useValidatedId({ fallbackRoute: "/" })
  ...
  const openConfirmModal = (tutor: Tutor) => {
    setConfirmModal({ isOpen: true, tutor })
  }

  const closeConfirmModal = () => {
    setConfirmModal({ isOpen: false, tutor: null })
  }

  const handleConfirmLink = async () => {
    if (!confirmModal.tutor || !petId) return

    const tutorId = confirmModal.tutor.id
    setLinking(tutorId)
  ...
  return (
    <>
      <ConfirmModal
        ...
        message={`Deseja vincular "${confirmModal.tutor?.nome}" como tutor responsável deste pet?`}
        ...
        <div className="container mx-auto px-4 py-8 max-w-6xl">
          <header className="mb-10">
            <button
              ...
              className="group inline-flex items-center gap-2 text-gray-500 hover:text-blue-600 font-medium mb-6 transition-colors duration-300 cursor-pointer"
            >
            ...
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
              ...
              <div className="relative w-full md:w-80">
                ...
                <input
                  ...
                  aria-label="Buscar tutor por nome"
          ...
          {!loading && tutores.length === 0 && (
            <div className="flex flex-col items-center justify-center py-20 px-6 bg-linear-to-b from-gray-50 to-white rounded-3xl border-2 border-dashed border-gray-200">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-linear-to-r from-blue-500 to-indigo-500 text-white font-bold shadow-lg shadow-blue-200/50 hover:shadow-xl hover:shadow-blue-300/50 hover:from-blue-600 hover:to-indigo-600 transition-all duration-300 cursor-pointer active:scale-[0.98]"
              >
                <svg
                  className="w-5 h-5"
                  fill="none"
